...
export class Splash extends Particle {
    ...
    constructor(game, x, y) {
        super(game)
        this.image = new Image()
        this.image.src = Math.random() < 0.7 ? 'secret/effects/fire.png' : 'secret/effects/ice-splash3.png'
...
export class IceSplash extends Particle {
    ...
    constructor(game, x, y) {
        super(game);
        this.image = new Image()
        this.image.src = 'secret/effects/ice-splash.png'
