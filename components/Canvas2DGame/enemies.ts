...
export class FlyingEnemy extends Enemy {
    ...
    constructor(game) {
        ...
        this.image.src = 'Canvas2DGame/enemies/winter/rocketman.png'
        this.rocketForceSound = new Audio('Canvas2DGame/sound/rocket_launch.mp3')
        this.angle = 0
        this.va = 0.1
        this.touched = false
    }
...
export class CandyPointEnemy extends Enemy {
    ...
    constructor(game) {
        ...
        this.maxFrame = 8
        this.image = new Image()
        this.image.src = 'Canvas2DGame/enemies/winter/candy_walk.png'
        this.stepSound = new Audio('Canvas2DGame/sound/stepsnow.mp3')
...
export class GolemEnemy extends Enemy {
    ...
    private readonly spriteMargin: number;
    ...
    constructor(game) {
        ...
        this.maxFrame = 11
        this.image = new Image()
        this.image.src = 'Canvas2DGame/enemies/winter/golem-walk.png'
        this.stepSound = new Audio('Canvas2DGame/sound/stepsnow2.mp3')
        this.attackSound = new Audio('Canvas2DGame/sound/golem-attack.mp3')
        this.slideSound = new Audio('Canvas2DGame/sound/golem-slide.mp3')
        this.stepSound.loop = true
        this.stepSound.play()
        this.vy = 0
        this.weight = 2
    ...
    slide() {
        if(this.actionDelay === 0) {
            this.image.src = 'Canvas2DGame/enemies/winter/golem-sliding.png'
        ...
        if(this.actionDelay < 3400) {
            this.image.src = 'Canvas2DGame/enemies/winter/golem-run.png'
            this.maxFrame = 11
            this.speedX = 3
            this.isSliding = false
        }
    ...
    jump() {
        if(this.actionDelay === 0) {
            this.vy -= 30
            this.image.src = 'Canvas2DGame/enemies/winter/golem-slashing.png'
            this.attackSound.play()
            this.speedX += 3
            this.actionDelay = 4000
        }
        if(this.actionDelay < 3400) this.image.src = 'Canvas2DGame/enemies/winter/golem-run.png'
    }
    onGround(){
...
export class YetiEnemy extends Enemy {
    ...
    private readonly roarCooldown: number;
    ...
    constructor(game) {
        ...
        this.maxFrame = 8
        this.image = new Image()
        this.image.src = 'Canvas2DGame/enemies/winter/yeti-walk.png'
        this.attackSound = new Audio('Canvas2DGame/sound/yeti-attack.mp3')
        this.roarSound1 = new Audio('Canvas2DGame/sound/yeti-roar1.mp3')
        this.roarSound2 = new Audio('Canvas2DGame/sound/yeti-roar2.mp3')
        this.stepSound = new Audio('Canvas2DGame/sound/stepsnow.mp3')
        this.stepSound.loop = true
        this.stepSound.play()
    ...
    attack() {
        if(this.actionDelay === 0) {
            this.image.src = 'Canvas2DGame/enemies/winter/yeti-attack.png'
